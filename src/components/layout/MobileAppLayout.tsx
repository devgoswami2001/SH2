                    ...
                    <ScrollArea className="flex-grow p-3 bg-muted/20 dark:bg-slate-900/30">
                        {appliedJobs.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground py-10">
                                 <header className="p-3 border-b border-border/50 bg-background/80 backdrop-blur-sm flex items-center justify-between sticky top-0 z-10 min-h-[56px] mt-5 w-full mb-6">
                                    {renderHeaderContent()}
                                </header>
